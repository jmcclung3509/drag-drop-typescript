//ENUM
enum ProjectStatus { Active, Finished } //Enum is a custom type that allows us to enumerate all the possible values
...
//Validate input
interface Validatable { //could also use a  custom type
	value: string | number;
	required?: boolean;
...
class ProjectList extends Component<HTMLDivElement, HTMLElement>{
	...
	constructor(private type: 'active' | 'finished') { //UNION TYPE
	...
	renderContent() { //Fill the blank spaces in template
		//ad id to UL
...
class ProjectInput extends Component<HTMLDivElement, HTMLFormElement>{
	...
	gatherUserInput(): [string, string, number] | void { //TUPLE   Return a tuple or nothing.  A Tuple is an array with fixed elements and types
	...
	private submitHandler(event: Event) {
		...
		if (Array.isArray(userInput)) { //A tuple is just an array
